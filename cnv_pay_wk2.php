...
$totals = mysql_query($sql = "SELECT staff_lastname, staff_firstname, cnv_date, SUM(cnv_hours) AS pd_hrs FROM canvass, staff WHERE (cnv_date >=  '2012-09-09' AND cnv_date <=  '2012-09-15') AND cnv_id = staff_id GROUP BY staff_lastname ORDER BY staff_lastname ASC");
